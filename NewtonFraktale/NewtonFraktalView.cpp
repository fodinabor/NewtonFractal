...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) {
	...
	case WM_GETMINMAXINFO:
		...
		minMaxInfo->ptMinTrackSize = NewtonFraktalView::minSize;
		break;
	case WM_MOUSEMOVE:
		if (core)
...
NewtonFraktalView::NewtonFraktalView(HINSTANCE hInstance, int nCmdShow, LPCTSTR windowTitle, POINT minSize, bool resizable, bool showDebugConsole) {
	...
	*/
	...
	wcex.lpszClassName = L"NewtonFractalGen";
	...
	if (resizable) {
		hwnd = CreateWindowEx(WS_EX_APPWINDOW, L"NewtonFractalGen", windowTitle, WS_OVERLAPPEDWINDOW | WS_SYSMENU, 0, 0, 640, 480, NULL, NULL, hInstance, NULL);
	} else {
		hwnd = CreateWindowEx(WS_EX_APPWINDOW, L"NewtonFractalGen", windowTitle, WS_CAPTION | WS_POPUP | WS_SYSMENU, 0, 0, 640, 480, NULL, NULL, hInstance, NULL);
	}
...
NewtonFraktalView::~NewtonFraktalView() {
